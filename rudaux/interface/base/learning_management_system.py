...
class LearningManagementSystem(ABC, BaseModel):
    ...
    @abstractmethod
    def get_assignments(self, course_group_name: str, course_section_name: str):
        pass

    @abstractmethod
    def get_submissions(self, course_group_name: str, course_section_name: str, assignment):
        pass
