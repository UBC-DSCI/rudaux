...
c.student_repo_name = 'the name of the student repository, e.g., dsci-100'
c.assignment_subdirectory = 'the subdirectory in the students repository where assignments are stored, e.g., materials'
