...
c.student_local_assignment_folder = 'the name of the student repository and the subdirectory in the students repository where assignments are stored (if it is used), e.g., dsci-100/materials'
